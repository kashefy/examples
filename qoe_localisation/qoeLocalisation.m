...
for jj = 1:length(humanLabelFiles)
    ...
    for ii = 1:size(humanLabels, 1)
        ...
        fprintf(1, '%s\t %4.0f deg\t %4.0f deg\t %4.0f deg\n', condition, perceivedAzimuth, ...
            predictedAzimuthDietz(ii), azimuthInPlusMinus180(predictedAzimuth(ii)));
        fprintf(fid1, '"%s", \t %5.2f, %5.2f, %4.0f, %4.0f\n', condition, X, Y, ...
            azimuthInPlusMinus180(perceivedAzimuth + headRotationOffset), ...
            azimuthInPlusMinus180(perceivedAzimuth - physicalAzimuth));
        fprintf(fid2, '"%s", \t %5.2f, %5.2f, %4.0f, %4.0f\n', condition, X, Y, ...
            azimuthInPlusMinus180(predictedAzimuthDietz(ii) + headRotationOffset), ...
            azimuthInPlusMinus180(predictedAzimuthDietz(ii) - physicalAzimuth));
        fprintf(fid3, '"%s", \t %5.2f, %5.2f, %4.0f, %4.0f\n', condition, X, Y, ...
            azimuthInPlusMinus180(predictedAzimuth(ii) + headRotationOffset), ...
            azimuthInPlusMinus180(predictedAzimuth(ii) - physicalAzimuth));
